...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `admin` (`adminID`, `password`, `adminType`, `district`, `city`, `name`, `contact`, `address`) VALUES ('$adminID', '$password', '$adminType', '$district', '$city', '$name', '$contact', '$address');";
    $addMun = mysqli_query($connection, $sql);

    $showAlert = "NGO added successfully";
...
<body>
    ...
    <h3 class="bg-secondary bg-gradient text-center text-light py-2 my-2">Add NGO</h3>


    <div class="container container-fluid my-5">
        <form class="" method="POST" action="addNGO.php">
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">AdminID</label>
                <input type="email" name="adminID" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter NGO's Email address" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="" class="form-label">Name of NGO</label>
                <input type="text" name="name" id="" class="form-control" placeholder="Name of NGO" required>
            </div>
            <div class="mb-3">
                <label for="" class="form-label">Contact No.</label>
                <input type="tel" name="contact" id="" class="form-control" placeholder="Enter contact no." required>
            </div>
            <div class="mb-3">
                <label for="form">Address</label>
                <textarea class="form-control" name="address" placeholder="NGO address" id="floatingTextarea" required></textarea>
            </div>
            <div class="mb-3">
