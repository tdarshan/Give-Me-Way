...
if (isset($_POST['submit'])) 
{
    ...
    if(isset($_FILES['image'])){
        ...
        move_uploaded_file($_FILES['image']['tmp_name'], "onRoad/". $_FILES['image']['name']);
        $iname = $_FILES['image']['name'];
        $sql = "INSERT INTO `cattleonroad` (`email`, `district`, `city`, `details`, `address`, `latitude`, `longitude`, `image`) VALUES ('$email', '$district', '$city', '$detail', '$address', '$latitude', '$longitude', 'dummy');";
        // echo $sql;
        // exit();
...
<head>
    ...
    <title>Complaint | Cattle On Road</title>
</head>
...
<body>
    ...
    <div class="container container-fluid m-4 p-4 bg-light bg-gradient">
        <form method="POST" action="cattleOnRoad.php" id="form" enctype="multipart/form-data">
            <p id="coordinates"></p>
            <!-- <div class="mb-3">
                <div class="f-group">
